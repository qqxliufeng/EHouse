...
public class RoundedNoNetImageView extends AppCompatImageView {
  ...
  public RoundedNoNetImageView(Context context) {
    super(context);
  }

  public RoundedNoNetImageView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public RoundedNoNetImageView(Context context, AttributeSet attrs, int defStyle) {
