...
public class DecorateSearchConditionAreaFragment extends LroidBaseNetFragment {
    ...
    protected void initView(View view) {
        ...
        rv_area.setAdapter(new MyRecyclerAreaAdapter(R.layout.fragment_decorate_search_condition_area_item_layout, mArrayList));
    }
    ...
    static class MyRecyclerAreaAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

        public MyRecyclerAreaAdapter(int layoutResId, List<String> data) {
            super(layoutResId, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, String item) {
            helper.setText(R.id.id_cb_adapter_area_item, item);
        }
    }
}
