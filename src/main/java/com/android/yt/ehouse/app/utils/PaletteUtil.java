...
public class PaletteUtil implements Palette.PaletteAsyncListener{
    ...
    public synchronized void onGenerated(Palette palette) {
        ...
        patternCallBack.onCallBack(changedImageViewShape(a.getRgb(),colorEasy),a.getTitleTextColor(),a.getRgb());
    }
    ...
    public interface PatternCallBack{
        void onCallBack(Drawable drawable,int titleColor,int bgColor);
    }
