    ...
    public void initView(View view) {
        ...
        headerView.findViewById(R.id.id_tv_fragment_decorate_index_note).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                KtFragmentContainerActivity.Companion.startFragmentsActivity(mContext, "", KtFragmentContainerActivity.Companion.getNOTE_DECORATE_LIST_FLAG());
            }
        });
        headerView.findViewById(R.id.id_tv_fragment_decorate_index_image).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                KtFragmentContainerActivity.Companion.startFragmentsActivity(mContext, "日记图集", KtFragmentContainerActivity.Companion.getNOTE_IMAGES_FLAG());
            }
        });
        ...
        headerView.findViewById(R.id.id_tv_fragment_decorate_index_more).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                KtFragmentContainerActivity.Companion.startFragmentsActivity(mContext, "装修公司", KtFragmentContainerActivity.Companion.getDECORATE_COMPANY_LIST_FLAG());
            }
        });
